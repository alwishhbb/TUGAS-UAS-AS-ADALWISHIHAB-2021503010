...
<head>
    ...
    <title>Penilaian Mahasiswa KG</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="<?php echo base_url();?>/assets/dist/img/sunrise.jpg" alt="AdminLTELogo"
                height="60" width="60">
        </div>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2023-2024 <a href="https://adminlte.io">PenilaianMahasiswa.io</a>.</strong>
            All rights reserved.
